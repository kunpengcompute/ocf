...
void ocf_metadata_set_collision_info(struct ocf_cache *cache, ocf_cache_line_t line, ocf_cache_line_t next)
{
...
void ocf_metadata_set_collision_next(struct ocf_cache *cache, ocf_cache_line_t line, ocf_cache_line_t next)
{
	struct ocf_metadata_list_info *info;
	struct ocf_metadata_ctrl *ctrl =
		(struct ocf_metadata_ctrl *) cache->metadata.priv;
...
void ocf_metadata_get_collision_info(struct ocf_cache *cache, ocf_cache_line_t line, ocf_cache_line_t *next)
{
		...
		ocf_cache_line_t line, ocf_part_id_t part_id)
{
	...
	// no prev cacheline anymore, we have to get hash from ocf_metadata_map
	...
	// set curr next to max value
	ocf_metadata_set_collision_next(cache, line, line_entries);
	// set core info to NULL
	ocf_metadata_set_core_info(cache, line, OCF_CORE_MAX, ULLONG_MAX);
}
